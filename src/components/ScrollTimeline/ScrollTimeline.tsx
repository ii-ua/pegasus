...
export const ScrollTimeline = ({ items }: { items: Item[] }) => {
  return (
    <div className="flex items-stretch">
      ...
      <ul className="flex flex-col flex-1 justify-center gap-[42px]">
...
const TimeLineItemTitle = ({ title }: { title: string }) => {
  return (
    <li>
      <h3 className="text-white font-medium uppercase max-w-[321px] text-[32px]">
        {title}
      </h3>
    </li>
  )
