  ...
  return (
    ...
    >
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex flex-col max-w-[795px] desktop:max-w-[957px] gap-4 tablet:gap-6 desktop:gap-8 relative z-10"
      >
        <motion.div
        ...
        <div className="flex flex-col gap-6 items-center">
          {paragraphs.map((text, i) => (
            <motion.p
              key={text}
              className="font-normal first-letter-cap text-[#D9D9D9] text-[16px] tablet:text-[20px] desktop:text-[24px] text-center"
