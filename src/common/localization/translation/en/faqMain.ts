const faqMain = {
  ...
  faqs: {
      ...
      questions: {
        ...
        q2: {
          ...
          answer: [
            ...
            'Communication range: up to 30 km',
    ...
    manufacturing: {
      ...
      questions: {
        q1: {
          question: 'HOW LONG DOES IT TAKE TO PRODUCE ONE SYSTEM?',
          answer:
            'The standard production time is 7–14 days. Priority deliveries are possible for urgent needs of the Defense Forces.',
        },
        q2: {
    ...
    training: {
      title: '/ Training and Application',
      questions: {
        q1: {
